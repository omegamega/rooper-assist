loadTragedySet = function(name){
	switch(name){
		case "MysteryCircle":
			TragedySet.loadMysteryCircle();
			break;
		case "HauntedStage":
			TragedySet.loadHauntedStage();
			break;
		default:
			TragedySet.loadBasicTragedy();
			break;
	};
...
TragedySet = {
	...
	loadHauntedStage : function(){
	},
	// ---- ここまでHauntedStage
	
	// 以下、新しい惨劇セット用のテンプレ
	_loadNewTragedySetTemplate : function(){
		tragedy_name = "NewTragedy";
		roles = [
			{
				name 		: "パーソン",
				alias		: "person",
